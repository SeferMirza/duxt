...
public class StyleGeneration
{
    ...
    {
        var expected = @"<html><head><title>Test</title><link href=""styles1.css"" rel=""stylesheet""><link href=""styles2.css"" rel=""stylesheet""><meta name=""og"" content=""duxt"" property=""og:title""><meta name=""og"" content=""duxt.jpg"" property=""og:image""></head><body><div><div class=""duxtClass"" id=""duxtId"">duxt</div><div class=""testClass"" id=""testId"" style=""text-align: center;"">test</div></div></body><style>.duxtClass { color: red; } .test { align-items: center; }</style></html>";
